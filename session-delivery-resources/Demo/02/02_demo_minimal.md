...
2. Agents & services: Single-agent demo (also multi-agent exists) with business service endpoints connected to Microsoft Foundry; supports semantic kernel LLMs and semantic agents. [00:00:27 – 00:00:41]
