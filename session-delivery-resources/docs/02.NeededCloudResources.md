...
1. Open a terminal and navigate to the console application directory (project infra folder):
...
Plain text log written to: ./infra/bin/Debug/net9.0/CreatedAgents.txt
JSON connection string map written to: ./infra/bin/Debug/net9.0/CreatedAgents.json
```
